...
export const AIEngineeringSection: React.FC = () => {
  ...
  return (
    <section id="ai-systems" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 relative border-t border-white/[0.08]">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="space-y-3.5">
          ...
          <p className="text-slate-300 text-base sm:text-lg max-w-3xl font-normal leading-relaxed">
        ...
        <div className="space-y-7">
            ...
            {AI_PIPELINE_STAGES.map((stage) => {
              ...
              return (
                <button
                  ...
                  className={`p-3.5 sm:p-4 rounded-xl flex flex-col items-start text-left transition-all border ${
                    isSelected
          ...
          <div className="p-6 sm:p-10 rounded-2xl bg-[#0c1017] border border-white/[0.08] grid grid-cols-1 lg:grid-cols-12 gap-8 items-start shadow-sm">
            ...
            <div className="lg:col-span-6 p-5 sm:p-7 rounded-2xl bg-white/[0.02] border border-white/[0.06] space-y-4">
