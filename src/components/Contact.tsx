...
export const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 relative border-t border-white/[0.06]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-[#0c1017] border border-white/[0.08] space-y-3">
              ...
              <a
                ...
                className="block text-base sm:text-lg font-semibold text-white hover:text-emerald-400 transition-colors break-all"
              >
                {PERSONAL_INFO.email}
              </a>
            </div>
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.06] flex items-center space-x-2.5 text-xs text-slate-300 font-mono">
              ...
              <span>{PERSONAL_INFO.location} · Open to Remote & Onsite</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            <form
              ...
              className="p-6 sm:p-7 rounded-2xl bg-[#0c1017] border border-white/[0.08] space-y-4"
            >
              ...
              {submitted && (
                <div className="p-3 rounded-lg bg-emerald-950/40 border border-emerald-500/30 text-xs text-emerald-300 flex items-center space-x-2">
                  ...
                  <span>Email client opened with formatted message. Looking forward to connecting!</span>
                </div>
              )}
            </form>
          </div>
