...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    category: 'Generative AI / NLP / Fit Analysis',
    targetAudience: 'Designed for Job Seekers & Candidates',
    featured: false,
    tagline: 'AI-powered resume-to-job fit analysis comparing candidate resumes against specific job descriptions to evaluate match quality, identify missing skills, and provide actionable recommendations.',
    description: 'An intelligent resume-to-job fit analysis application built for candidates and job seekers. By comparing uploaded resumes directly against target job descriptions, the system evaluates role alignment, highlights matching qualifications, identifies missing skill gaps, and provides actionable recommendations to improve candidate readiness.',
    problemTitle: "How well does my resume match the role I'm applying for?",
    problem: 'Candidates often apply to jobs without knowing how closely their resume matches the actual requirements of the role. It can be difficult to identify which skills already match the job description, which requirements are missing, and what should be improved before applying.',
    solutionTitle: 'Paste the job description, upload your resume, and let the AI analyze the fit.',
    solution: "The system compares the resume against the specific job description, identifies matching and missing skills, evaluates the overall fit, and provides actionable recommendations to improve the candidate's profile for that role.",
    candidateWorkflow: [
      { step: '01', label: 'JOB DESCRIPTION + RESUME', sub: 'Candidate inputs target Job Description and uploads PDF resume' },
      { step: '02', label: 'AI ANALYSIS', sub: 'Semantic context mapping via LangChain LCEL & Groq LLM' },
      { step: '03', label: 'ROLE FIT EVALUATION', sub: 'Objective match scoring with Pydantic validation' },
      { step: '04', label: 'MATCHING SKILLS', sub: 'Extraction of verified qualifications & candidate strengths' },
      { step: '05', label: 'MISSING / WEAK AREAS', sub: 'Pinpointing critical requirement gaps & missing tools' },
      { step: '06', label: 'IMPROVEMENT RECOMMENDATIONS', sub: 'Prioritized action items to optimize profile before applying' },
    ],
    features: [
      'Designed for candidates to answer: "Based on my resume and this specific job description, how well am I suited for this role?"',
      'Compares uploaded PDF resumes against pasted Job Descriptions with zero hallucination',
      'Enforces type-safe Pydantic output schemas for objective match scoring and structured reporting',
      'Pinpoints exact matching qualifications and highlights missing or weak skill areas',
      'Generates prioritized, actionable recommendations to improve candidate resumes for target roles',
      'Interactive Streamlit UI with real-time feedback powered by LangChain LCEL and Groq LPU',
    ],
    technologies: [
      'Python',
      'LangChain',
    ...
    architectureNodes: [
      {
        title: '1. Role & JD Input',
        description: 'Candidate selects the target role, pastes the full Job Description, and uploads their PDF resume.',
        tools: 'Streamlit, File Uploader',
      },
      {
        title: '2. Resume PDF Parsing',
        description: 'Extracts structured text from candidate resumes using pdfplumber.',
        tools: 'pdfplumber',
      },
      {
        title: '3. LCEL Chain Orchestration',
        description: 'Orchestrates prompt pipelines and context mapping with LangChain Expression Language.',
        tools: 'LangChain LCEL',
      },
      {
        title: '4. Groq LLM Fit Analysis',
        description: 'Evaluates technical alignment, prerequisite matching, and skill gap identification.',
        tools: 'Groq API',
      },
      {
        title: '5. Pydantic Output Validation',
        description: 'Enforces type-safe schema validation on evaluation metrics and feedback.',
        tools: 'Pydantic',
      },
      {
        title: '6. Actionable Candidate Report',
        description: 'Presents role-fit scores, matching skills, gaps, and tailored profile improvements.',
        tools: 'Streamlit',
      },
    ],
  },
