      ...
      <div className="py-8 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-24 sm:space-y-32">
          ...
          {CURRENTLY_EXPLORING.map((item, idx) => {
            ...
            return (
              <Link
                key={idx}
                to={item.link}
                className="block pt-12 sm:pt-16 first:pt-0 border-t border-white/[0.08] first:border-none space-y-5 group"
              >
                ...
                <div className="space-y-3">
                  <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight group-hover:text-violet-200 transition-colors flex items-center justify-between">
                    <span>{item.title}</span>
                    <ArrowRight className="w-5 h-5 sm:w-6 h-6 text-slate-500 group-hover:text-violet-400 group-hover:translate-x-1.5 transition-all shrink-0 ml-4" />
                  </h2>
        ...
        <section className="space-y-8 pt-10 border-t border-white/[0.08]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            <div className="p-7 rounded-3xl bg-[#110e20] border border-violet-500/25 space-y-3 shadow-sm">
              <span className="text-sm font-mono text-violet-400 font-bold">01 / Cyclic Graphs</span>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
                LangGraph enables cyclical reasoning loops and automatic retry logic on schema validation failures.
              </p>
            </div>
            <div className="p-7 rounded-3xl bg-[#09121d] border border-cyan-500/25 space-y-3 shadow-sm">
              <span className="text-sm font-mono text-cyan-400 font-bold">02 / Dynamic Tools</span>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <div className="p-7 rounded-3xl bg-[#0a1512] border border-emerald-500/25 space-y-3 shadow-sm">
              <span className="text-sm font-mono text-emerald-400 font-bold">03 / Checkpoints</span>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
