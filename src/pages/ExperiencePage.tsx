  ...
  return (
    <div className="relative page-enter">
      ...
      <div className="py-8 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-24 sm:space-y-32">
        ...
        <div className="relative pl-8 sm:pl-12 border-l-2 border-emerald-500/35 space-y-14">
            ...
            <div key={idx} className="relative space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap items-center gap-2.5 text-base sm:text-lg text-slate-300">
                ...
                {/* Clean Statement */}
                <p className="text-base sm:text-lg lg:text-xl text-slate-200 leading-relaxed font-normal pt-1 max-w-4xl">
        ...
        <div className="pt-10 border-t border-white/[0.08] space-y-7">
          ...
          <div className="flex flex-wrap items-center gap-3.5 pt-1">
            <button
              ...
              className="inline-flex items-center space-x-2.5 px-6 py-3.5 sm:px-7 sm:py-4 rounded-xl bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-slate-950 font-bold text-sm sm:text-base transition-all shadow-lg shadow-emerald-500/25 active:scale-[0.99]"
            >
            ...
            <a
              ...
              className="inline-flex items-center space-x-2.5 px-6 py-3.5 sm:px-7 sm:py-4 rounded-xl bg-white/[0.06] hover:bg-white/[0.12] text-slate-200 border border-white/[0.12] text-sm sm:text-base font-semibold transition-all"
            >
