    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-16">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          <span className="text-xs font-mono text-slate-400 bg-white/[0.03] px-2.5 py-0.5 rounded border border-white/[0.06]">
            {detail.tag}
          </span>
        </div>
      ...
      <div className="space-y-6 pt-4 border-t border-white/[0.06]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {detail.architectureFlow.map((flow, idx) => (
            <div
              key={idx}
              className="p-5 rounded-xl bg-[#0c1017] border border-white/[0.08] space-y-2"
            >
