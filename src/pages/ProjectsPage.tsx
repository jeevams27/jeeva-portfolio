        ...
        <div className="space-y-16 sm:space-y-24">
          {PROJECTS.map((project, idx) => {
            ...
            return (
              <article
                key={project.id}
                className="pt-12 sm:pt-16 first:pt-0 border-t border-white/[0.08] first:border-none space-y-7 group"
              >
                {/* Meta Header */}
                ...
                <div className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1">
                    {project.features.slice(0, 4).map((feat, fIdx) => (
                      <div key={fIdx} className="flex items-start space-x-3 text-sm sm:text-base lg:text-lg text-slate-200">
