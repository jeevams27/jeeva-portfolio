    ...
    <div className="relative page-enter">
      ...
      <div className="py-8 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-24 sm:space-y-32">
        ...
        <div className="flex items-center justify-between border-b border-white/[0.08] pb-5">
          ...
          <span className="text-xs sm:text-sm font-mono text-purple-300 bg-purple-950/60 px-3.5 py-1 rounded-md border border-purple-500/30 font-bold shadow-[0_0_12px_rgba(168,85,247,0.15)]">
            {detail.category}
          </span>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-slate-300 text-lg sm:text-2xl leading-relaxed max-w-4xl font-normal">
            {detail.tagline}
          </p>
        </div>
        ...
        <section className="space-y-5 pt-10 border-t border-white/[0.08]">
          <div className="flex items-center space-x-2.5 text-xs sm:text-sm font-mono text-purple-400 uppercase tracking-widest font-bold">
        ...
        <section className="space-y-8 pt-10 border-t border-white/[0.08]">
          ...
          <div className="space-y-4">
            {detail.pipelineSteps.map((step, idx) => (
              <div
                key={idx}
                className="flex flex-col sm:flex-row sm:items-center justify-between p-6 rounded-2xl bg-[#0e101a] border border-purple-500/25 hover:border-purple-500/45 transition-all gap-4 shadow-sm"
              >
                <div className="flex items-start sm:items-center space-x-4">
                  <span className="w-9 h-9 rounded-xl bg-purple-950/70 border border-purple-500/40 text-purple-300 text-sm font-mono font-bold flex items-center justify-center shrink-0 shadow-sm">
                    0{idx + 1}
                  </span>
                  <div>
        ...
        <section className="space-y-5 pt-10 border-t border-white/[0.08]">
          <div className="flex items-center space-x-2.5 text-xs sm:text-sm font-mono text-cyan-400 uppercase tracking-widest font-bold">
        ...
        <section className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-purple-950/40 via-[#0c1017] to-indigo-950/40 border border-purple-500/30 space-y-6 shadow-[0_0_40px_rgba(168,85,247,0.12)]">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            ...
            <Link
              ...
              className="inline-flex items-center space-x-2.5 px-7 py-3.5 rounded-xl bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-400 hover:to-indigo-500 text-white font-bold text-sm sm:text-base transition-all shadow-lg shadow-purple-500/25 shrink-0 active:scale-[0.99]"
            >
        ...
        <section className="space-y-5 pt-10 border-t border-white/[0.08]">
          ...
          <div className="flex flex-wrap gap-2.5 pt-1">
            {detail.relatedTechnologies.map((tech, idx) => (
              <span
                key={idx}
                className="px-4 py-2 rounded-xl bg-white/[0.04] text-xs sm:text-sm font-mono text-slate-200 border border-white/[0.08]"
              >
                {tech}
              </span>
            ))}
