    ...
    <div className="relative page-enter">
      ...
      <div className="py-8 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-24 sm:space-y-32">
        ...
        <div className="space-y-4 max-w-4xl">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black tracking-tight text-white leading-[1.05]">
            Let’s Build{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-400">
              Something Intelligent
            </span>.
          </h1>
          <p className="text-slate-300 text-lg sm:text-xl leading-relaxed max-w-3xl font-normal">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {/* Email Quick Action */}
          <div className="p-7 rounded-3xl bg-[#090e18] border border-cyan-500/25 space-y-3 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.08] text-xs font-mono text-slate-300 hover:text-white transition-colors"
              >
            ...
            <a
              ...
              className="block text-xl sm:text-2xl font-bold text-white hover:text-cyan-300 transition-colors font-mono break-all"
            >
              {PERSONAL_INFO.email}
            </a>
          </div>
          ...
          {/* Phone Quick Action */}
          <div className="p-7 rounded-3xl bg-[#100d1c] border border-purple-500/25 space-y-3 shadow-sm">
            <div className="flex items-center justify-between">
            ...
            <a
              ...
              className="block text-xl sm:text-2xl font-bold text-white hover:text-purple-300 transition-colors font-mono"
            >
        ...
        <div className="flex flex-wrap gap-5">
          <a
            ...
            className="flex-1 min-w-[200px] p-6 rounded-2xl bg-[#090e18] border border-white/[0.08] hover:border-cyan-500/40 transition-all flex items-center justify-between group shadow-sm"
          >
            <div className="flex items-center space-x-3.5">
              <Github className="w-5 h-5 text-slate-400 group-hover:text-cyan-400 transition-colors" />
              <span className="font-bold text-white text-base">GitHub Profile</span>
            </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 min-w-[200px] p-6 rounded-2xl bg-[#100d1c] border border-white/[0.08] hover:border-purple-500/40 transition-all flex items-center justify-between group shadow-sm"
          >
            <div className="flex items-center space-x-3.5">
              <Linkedin className="w-5 h-5 text-slate-400 group-hover:text-purple-400 transition-colors" />
              <span className="font-bold text-white text-base">LinkedIn Profile</span>
            </div>
        ...
        <div className="pt-8 border-t border-white/[0.08]">
          <form
            ...
            className="p-8 sm:p-12 rounded-3xl bg-[#0c121e] border border-cyan-500/25 space-y-6 shadow-[0_0_40px_rgba(6,182,212,0.08)]"
          >
            ...
            <button
              type="submit"
              className="w-full inline-flex items-center justify-center space-x-2.5 px-7 py-4 rounded-xl bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-slate-950 font-bold text-sm sm:text-base transition-all shadow-lg shadow-emerald-500/25 active:scale-[0.99]"
            >
            ...
            {submitted && (
              <div className="p-4 rounded-xl bg-emerald-950/50 border border-emerald-500/40 text-xs sm:text-sm text-emerald-300 flex items-center space-x-2.5">
