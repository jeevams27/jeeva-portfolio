    ...
    <div className="relative page-enter">
      ...
      <div className="py-8 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-24 sm:space-y-32">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-4">
            {project.liveDemo && (
              <a
                ...
                className="inline-flex items-center space-x-2 px-7 py-3.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-bold text-sm sm:text-base transition-all shadow-lg shadow-cyan-500/25 active:scale-[0.99]"
              >
            ...
            {project.github && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center space-x-2 px-6 py-3.5 rounded-xl bg-white/[0.06] hover:bg-white/[0.12] text-slate-200 hover:text-white border border-white/[0.12] text-sm sm:text-base font-semibold transition-all"
              >
        ...
        <section className="space-y-5 pt-10 border-t border-white/[0.08]">
          <div className="flex items-center space-x-2.5 text-xs sm:text-sm font-mono text-rose-400 uppercase tracking-widest font-bold">
        ...
        <section className="space-y-5 pt-10 border-t border-white/[0.08]">
          <div className="flex items-center space-x-2.5 text-xs sm:text-sm font-mono text-emerald-400 uppercase tracking-widest font-bold">
        ...
        <section className="space-y-8 pt-10 border-t border-white/[0.08]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {project.architectureNodes.map((node, nIdx) => (
              <div
                key={nIdx}
                className="p-7 rounded-3xl bg-[#090e18] border border-cyan-500/25 hover:border-cyan-500/45 transition-all space-y-4 flex flex-col justify-between shadow-sm"
              >
        ...
        <section className="space-y-8 pt-10 border-t border-white/[0.08]">
          ...
          <div className="space-y-4">
            {project.features.map((feat, fIdx) => (
              <div key={fIdx} className="flex items-start space-x-3.5 text-base sm:text-lg text-slate-200">
        ...
        <div className="pt-12 border-t border-white/[0.08] flex flex-wrap items-center justify-between gap-4">
          {prevProject ? (
            <Link
              ...
              className="inline-flex items-center space-x-2.5 text-xs sm:text-sm font-mono text-slate-400 hover:text-cyan-300 transition-colors font-semibold"
            >
